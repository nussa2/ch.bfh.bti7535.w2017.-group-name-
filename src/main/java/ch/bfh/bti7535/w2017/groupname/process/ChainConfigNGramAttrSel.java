...
import ch.bfh.bti7535.w2017.groupname.filter.PreprocessingNGramFilter;
 ...
 */
public class ChainConfigNGramAttrSel implements ProcessChainConfiguration {
    ...
    public void init() {
        ...
        addStep(new PreprocessingNGramFilter());
